...
<div class="header">
	...
	<ul class="nav">
		...
		<!-- <li class="menu dropdown">
			<div class="menu-hd dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
			    <a href="#">项目<span class="caret"></span></a>
			</div>
			<div class="menu-bd dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownMenu1">
				 <ul >
